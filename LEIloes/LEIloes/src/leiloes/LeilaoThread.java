 ...
 * utilizador através de um cliente e comunicar respostas ao mesmo.
 * 
...
public class LeilaoThread extends Thread {
     ...
     * @param contadores 
     */
    public LeilaoThread(Socket sock, Utilizadores users, InfoLeiloes i,
                        Map<String, ArrayList<String>> n,
                        Map<String, SharedCondition> sc,
                        Map<String, CounterNotes> contadores) {
        this.sock = sock;
        this.users = users;
        username = "";
        info = i;
     ...
     * É enviado um sinal de sucesso ao cliente caso o login tenha sido efectuado
     * corretamente.
     * 
    ...
    private void loginCliente(String user, String pass, PrintWriter pw) {
        ...
        nt = new NotifyThread(sock, notes.get(username), sha, c);
        nt.start();
