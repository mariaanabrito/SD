...
/**
 * @brief Definição da Classe InfoLeiloes.
 * 
 * @author Bruno Pereira      - 75135
 * @author Carlos Pereira     - 61887
 * @author Diogo Silva        - 76407
...
public class InfoLeiloes {
    ...
    private Map<Integer, Item> leiloes;         /* A Key é o id do leilão e o Value é o objecto Item. */
    private Map<Integer, ReentrantLock> locks;  /* A Key é o id do leilão e o Value, o lock correspondente. */
