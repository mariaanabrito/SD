...
public class Cliente {
    ...
    private static boolean notSlow; // slow = false quando atinge limite de
                                    //notificações
    
    private static boolean exit; // exit = true quando quer sair do programa
    ...
    public static void main(String[] args) {
         /*
         * Definição e inicialização de todas as variáveis necessárias ao
         * método main.
         */
        try {
            /*
            ...
            /*
             * Inicialização dos menus usados no ciclo de leitura e escrita
             * para o servidor.
             */
            carregarMenus();
             ...
             */
            String linha = "1"; //opção lida do menu inicial
            int op = 0;         //opção lida do menu principal
            
            notSlow = true; //Inicialização de res como variável de instância.
            exit = false; //Inicialmente o utilizador não pretende sair do programa
            ...
            while (notSlow && !(linha.equals("0"))) {
                ...
                while (notSlow && login) {
                    ...
                    while(notSlow && (op = lerOpcaoMenuPrincipal())!= 0) {
                    ...
                    /* Se utilizador pretender sair, avisamos o servidor. */
                    if (op == 0) {
                        logout(pw);
                    }
            ...
            /* Se saiu do ciclo por notSlow = falso então o cliente foi
               forçado a terminar. */
            if (!notSlow) {
